const preload = () => {
  ...
  class CreateParticles {
      ...
      adjustForScreenSize() {
        ...
        if (screenWidth < 600) { // Example breakpoint - adjust as needed
            this.data.textSize = 2.5; // Smaller text size for small screens
            this.data.amount = 100; // Fewer particles for performance
           
        } else {
            // Default values or other breakpoints as needed
        }
    }
  
      bindEvents() {
  
        document.addEventListener('mousedown', (e) => this.onPointerDown(e.clientX, e.clientY));
